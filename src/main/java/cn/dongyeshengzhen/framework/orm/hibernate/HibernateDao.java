...
// */
//package cn.dongyeshengzhen.framework.orm.hibernate;
//
...
//import cn.dongyeshengzhen.framework.orm.Page;
//import cn.dongyeshengzhen.framework.orm.PropertyFilter;
//import cn.dongyeshengzhen.framework.orm.PropertyFilter.MatchType;
//import cn.dongyeshengzhen.framework.utils.ReflectionUtils;
...
//
//		if (page.isAutoCount()) {
//			long totalElements = countHqlResult(hql, values);
...
//
//		if (page.isAutoCount()) {
//			long totalElements = countCriteriaResult(c);
//			page.setTotalElements(totalElements);
//		}
//
...
//		long totalElements = (totalCountObject != null) ? totalCountObject : 0;
//
