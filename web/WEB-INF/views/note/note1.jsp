...
<head>
    ...
    <meta name="description" content="Leanote, 蚂蚁笔记, moto">
    <title>Leanote, moto"</title>
    <link href="/resource/css/bootstrap-min.css" rel="stylesheet" />
    <!-- 先加载, 没有样式, 宽度不定 -->
    <link rel="stylesheet" href="/resource/css/tinymce/skin.min.css" rel="stylesheet"/>
    <!-- leanote css -->
    <link href="/resource/css/font-awesome-4.2.0/css/font-awesome-min.css" rel="stylesheet" />
    <link href="/resource/css/zTreeStyle/zTreeStyle-min.css" rel="stylesheet" />
    <!-- mdeditor -->
    <link href="/resource/public/md/themes/default.css" rel="stylesheet" />
    <!-- context-menu -->
    <link rel="stylesheet" href="/resource/js/contextmenu/css/contextmenu-min.css?id=1" type="text/css" />
    <script>
...
<div id="page">
    <div id="pageInner">
        ...
        <div id="header">
            <a id="logo" href="/" title="Leanote home" class="pull-left"></a>
            ...
            <div class="pull-right" id="myProfile">
                <div class="dropdown">
                    <a class="dropdown-toggle profile-img" title="${userInfo.username}" data-toggle="dropdown">
                        <img alt="${userInfo.username}" title="${userInfo.username}" src="<c:if test="${not empty userInfo.logo}">${userInfo.logo}</c:if><c:if test="${not empty userInfo.logo}">/images/blog/default_avatar.png</c:if>" id="myAvatar"/>
                        <span class="username">
                            ${userInfo.username}
							</span>
                        <i class="fa fa-angle-down"></i>
            ...
            <c:if test="${userInfo.email eq 'demo@leanote.com'}" >
            <c:if test="${openRegister}" >
        ...
        <div id="mainContainer" class="clearfix">
            <div id="mainMask">
                <img src="/resource/images/loading-30.gif" />
                <br />
                <br />
                loading...
            </div>
...
<div id="noteAndEditor">
    <div id="noteAndEditorMask">
        <img src="/resource/images/loading-24.gif"/>
        <br />
        loading...
    </div>
    <div id="noteList">
            ...
            <div class="modal-body">
                <table id="themeForm">
                    <tr>
                        <td>
                            <label>
                                <img src="/resource/images/slider/all.gif" height="100px">
                                <br />
                        ...
                        <td>
                            <label>
                                <img src="/resource/images/slider/all-simple.gif" height="100px">
                                <br />
...
<script>
    ...
    var notes = '${notes}';
    var latestNotes =<c:if test="${not empty latestNotes}">${latestNotes}</c:if><c:if test="${empty latestNotes}">[]</c:if>;
    var noteContentJson = '${noteContentJson}';
    var tagsJson = '${tags}';
    var GlobalConfigs = '${globalConfigs}';
    var tinyMCEPreInit = '${base}' +'/resource/public/tinymce'+ '${suffix}' +'.min';
</script>
<script src="/resource/js/i18n/msg.${locale}.js"></script>
<script src="/resource/js/dep.min.js"></script>
<script src="/resource/tinymce/tinymce.full.min.js"></script>
<script src="/resource/public/libs/ace/ace.js"></script>
<script src="/resource/js/app.js"></script>
<script>
    initPage();
    // 当tinymce.dev.js时, 请注释require
    window.require = {
        baseUrl: '/resource/public',
    };
</script>
<script src="/resource/js/markdown-v2.min.js"></script>
<script src="/resource/public/js/plugins/main.min.js"></script>
</body>
</html>
